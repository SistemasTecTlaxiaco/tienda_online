    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form id="formCliente" name="formCliente" class="form-horizontal">
              ...
              <p class="text-primary">Los campos con asterisco (<spam class="required">*</spam>) son obligatorios.</p>

            
              <div class="form-row">
              <div class="form-group col-md-4">
                  <label for="txtIdentificacion">Identificación (<spam class="required">*</spam>)</label>
                  <input type="text" class="form-control" id="txtIdentificacion" name="txtIdentificacion" required="">
                </div>
                <div class="form-group col-md-4">
                  <label for="txtNombre">Nombres (<spam class="required">*</spam>)</label>
                  <input type="text" class="form-control valid validText" id="txtNombre" name="txtNombre" required="">
                </div>
                <div class="form-group col-md-4">
                  <label for="txtApellido">Apellidos (<spam class="required">*</spam>)</label>
                  <input type="text" class="form-control valid validText" id="txtApellido" name="txtApellido" required="">
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col-md-4">
                  <label for="txtTelefono">Teléfono (<spam class="required">*</spam>)</label>
                  <input type="text" class="form-control valid validNumber" id="txtTelefono" name="txtTelefono" required="" onkeypress="return controlTag(event);">
                </div>
                <div class="form-group col-md-4">
                  <label for="txtEmail">Email (<spam class="required">*</spam>)</label>
              ...
              <div class="col-md-6">
                  <label>Identificación Tributaria (<spam class="required">*</spam>)</label>
                  <input class="form-control" type="text" id="txtNit" name="txtNit" required="">
              </div>
              <div class="col-md-6">
                  <label>Nombre fiscal (<spam class="required">*</spam>)</label>
                  <input class="form-control" type="text" id="txtNombreFiscal" name="txtNombreFiscal" required="">
              </div>
              <div class="form-group col-md-12">
                  <label>Dirección fiscal (<spam class="required">*</spam>)</label>
