    ...
    //MOSTRAR INFORMACION DE INTERACTIVIDAD
      const showInfo = () => {
        ...
        emailButton.addEventListener('click', function (evt) {
          window.location.href = "https://tiendapcbox.herokuapp.com/tienda/producto/9/bocinas-techzone-tzboctws-inalambricas-bluetooth-negro";
          text.setAttribute("value", "Estamos preparando su compra, gracias por visitar PC BOX :D");
          currentTab = 'email';
        });
        profileButton.addEventListener('click', function (evt) {
          text.setAttribute("value", "Bocinas Techzone TZBOCTWS Inalámbricas Bluetooth Negro");
          currentTab = 'profile';
        });
  ...
  <body>
    ...
    <a-scene mindar-image="imageTargetSrc: https://tiendapcbox.herokuapp.com/Assets/images/targets.mind; showStats: false; uiScanning: #example-scanning-overlay;" embedded color-space="sRGB" renderer="colorManagement: true, physicallyCorrectLights" vr-mode-ui="enabled: false" device-orientation-permission-ui="enabled: false">
      <a-assets>
        ...
        <img id="icon-profile" crossorigin="anonymous" src="https://tiendapcbox.herokuapp.com/Assets/icons/info.png" />
        <img id="icon-web"  crossorigin="anonymous" src="https://tiendapcbox.herokuapp.com/Assets/icons/micro.png" />
        <img id="icon-email" crossorigin="anonymous" src="https://tiendapcbox.herokuapp.com/Assets/icons/link.png" />
        <!--<img id="icon-location" src="https://tiendapcbox.herokuapp.com/Assets/icons/micro.png" />-->
        <a-asset-item id="avatarModel" src="https://tiendapcbox.herokuapp.com/Assets/modelos/Bocina.glb"></a-asset-item>
      </a-assets>
      ...
      <a-entity id="mytarget" mytarget mindar-image-target="targetIndex: 0">
        ...
        <a-text id="text" class="clickable" value="" color="black" alignt="center" width="2" position="0 0.05 0" geometry="primitive:plane; height: 0.1; width: 2;" material="opacity: 0.5"></a-text>
